...
public class Commands {
	...
	public static final String EINNAHMEN = "controlling-einnahmen";
	public static final String AUSGABEN = "controlling-ausgaben";
	public static final String ERGEBNIS = "controlling-ergebnis";
	
	public static final String DOC = "documentation";
	
	public static final String KRAFTSTOFF_BESTAND = "kraftstoff-bestand";
	...
	public static final String JOURNAL = "verkauf-journal";
	
	public static final String WAREN_BESTAND = "waren-bestand";
	public static final String WAREN_BESTELLUNGEN = "waren-bestellungen";
